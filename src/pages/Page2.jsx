...
function Page2() {
  ...
  return (
    <div id="part2" className="p-8 bg-[#fafafa] relative">
      <h3 className="text-center text-lg font-[anzo3] mb-20 opacity-[0.7]">
      ...
      <div className="flex items-center justify-center mb-5 scale-[0.6]">
        <svg
      ...
      <div className="h-[2px] w-80 bg-black m-auto"></div>
    </div>
  );
}
